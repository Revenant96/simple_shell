...
/**
 * get_history_file - function to find history file
 * @info: struct
...
/**
 * write_history - function to create a file
...
/**
 * read_history - functio that reads history from file
 * @info: struct
...
/**
 * build_history_list - functio to add entry to a history linked list
 * @info: struct
 * @buf: buffer
 * @count: the history count
 * Return: Always 0
 */
